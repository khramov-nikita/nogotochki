...
| Вход через Яндекс | Кнопка на экранах входа/регистрации | Профиль с почтой и именем от провайдера. Поиск/создание `clients`, привязка `provider` / `provider_id`, сессия как у обычного входа. Токен Яндекса не храним. |
